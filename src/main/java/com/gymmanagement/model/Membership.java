 ...
 * <p>
 * Each membership has a type (e.g. Monthly, Annual), a description, a cost,
 * and start / end dates. The membership is associated with a specific member
 * via the {@code memberId} field.
 */
